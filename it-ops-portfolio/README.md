...
**What it tracks:**
- Open incidents, SLA breaches, and change requests
- Daily incident volume trends (opened vs. resolved)
- System uptime by category
- Root cause breakdown across departments

**Skills demonstrated:** Data visualization, KPI design, HTML/CSS/JS
...
**What it does:**
- Generates and processes a 200-row incident dataset
- Validates and cleans data for accuracy
- Identifies recurring system + cause combinations (RCA targets)
- Calculates average resolution time by root cause
- Flags SLA breaches and exports results to CSV for use in Excel or Power BI

**Skills demonstrated:** Python, data analysis, Root Cause Analysis (RCA), CSV export
...
| Tool | Used For |
|------|----------|
| Python | Data analysis, RCA logic |
| HTML / CSS / JS | Dashboard UI |
| Chart.js | Data visualization |
| CSV | Data export for Excel / Power BI |
